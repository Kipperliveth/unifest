...
function GetHelp() {
  ...
  return (
    ...
    <div className="gethelp-page page">
            ...
            <div className="accordion">
              <div className="left">
                ...
                >
                  ...
                  <div className="acc-content">
                   After orders have been ordered or delivered, a refund is not possible
                  </div>
                </div>
              </div>
              ...
              <div className="right">
                ...
                >
                  ...
                  <div className="acc-content">
                    ...
                    to reach out via our live chat or email us at
                    evanisinteriors@gmail.com.
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="acc-content">
                   Shipping is available nationwide!(Nigeria) and shipping fees are paid for seperately!
                  </div>
                </div>
              </div>
            </div>
